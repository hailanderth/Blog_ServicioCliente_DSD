...
namespace ServicioSOA
{
    public class ClienteRepositorio
    {
        ...
        public List<ClienteEntidad> Buscar(ClienteEntidad entidad)
        {
            ...
            {
                cn.Open();
                SqlCommand cmd = new SqlCommand("usp_Tb_Cliente_Buscar", cn);
                cmd.Parameters.Add(new SqlParameter("@Nom_Cliente", SqlDbType.VarChar, 100)).Value = (entidad.Nom_Cliente != null ? entidad.Nom_Cliente : "");
                cmd.Parameters.Add(new SqlParameter("@Ape_Cliente", SqlDbType.VarChar, 100)).Value = (entidad.Ape_Cliente != null ? entidad.Ape_Cliente : "");
                cmd.CommandType = CommandType.StoredProcedure;
                ...
                using (var reader = cmd.ExecuteReader())
                {
                    while (reader.Read())
                    {
                        ...
                        ListaClientes.Add(oClienteEntidad);
                    }
                }
